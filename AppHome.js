...
import { useNavigation } from '@react-navigation/native';  // Menambahkan navigasi
...
function App() {
  const navigation = useNavigation(); // Menggunakan navigasi
...
const styles = StyleSheet.create({
  ...
  profileImage: { width: 35, height: 35, borderRadius: 17.5 }, // Memperbaiki profil agar bulat
